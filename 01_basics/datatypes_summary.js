...
console.log(typeof outsidetemp); // object (this is because `null` is treated as an object)
console.log(typeof isLoggedIn); // boolean
console.log(typeof myFunction); // function
console.log(typeof anotherID);  // symbol
console.log(typeof heros);      // object (because arrays are technically objects)
